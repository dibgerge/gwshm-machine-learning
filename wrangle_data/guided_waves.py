"""
Extract the guided waves data from the .mat files collected from oscilloscopes and dump them into
one structured HDF5 file. Two different HDF5 are used: one for the received signals and one for
...
def _get_info_from_file(filename):
    ...
    return osc, scihdf.Info(actuator=actuator,
                            sensor=None,
                            frequency=frequency,
                            impact=impact_idx,
